...
{if(!BaseKit.Framework_Page.isMode(['edit']))
{that.forceDownload();}});if(BaseKit.Framework_Page.isMode(['edit','preview','themeselector','admin']))
...
var overlay=$('<div />').addClass('prevent-select').attr('id','bk-preview-image-overlay').css({position:"fixed",left:0,top:0,width:"100%",height:"100%",zIndex:"999997",opacity:0.9,background:"rgba(38,38,38,.85) url('http://www.nicwebsite.ru/framework/images/ui/loading-spinner.gif') no-repeat 50% 50%"}).appendTo(document.body);img.load(function()
