...
{alignX=$('<div></div>').addClass('hidden').css({position:'absolute',width:'1px',top:'0',height:'100%',background:'transparent url(http://www.nicwebsite.ru/framework/images/ui/align-guide.png) repeat-y 0 0',zIndex:900000});alignY=$('<div></div>').addClass('hidden').css({position:'absolute',height:'1px',left:'0',width:'100%',background:'transparent url(http://www.nicwebsite.ru/framework/images/ui/align-guide.png) repeat-x 0 0',zIndex:900000});}}
